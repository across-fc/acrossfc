...
def daily_clears_etl():
    ...
    if FC_CONFIG.discord_webhook_url is None:
        ...
        click.echo("Report published to Discord webhook")
    ...
    try:
        ...
        click.echo("Clear rates inserted successfully")
        ...
        LOG.debug(f"DynamoDB response: {response}")
        click.echo("Clear rates updated successfully")
    except Exception as e:
        LOG.error(e)
        click.echo("Error upserting item. Please check the logs for errors.")
